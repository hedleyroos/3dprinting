...
//
//   Pedestal — a chamfered rectangular slab with a matching
//     groove in its top face: the same ring, widened by
//     `joint_clearance` on both faces. Printed UPSIDE DOWN (top
//     face on the bed) so the show face gets the glassy bed
//     finish and the chamfers self-support.
//
...
pedestal_chamfer = 2;    // 45 deg chamfer on the top and bottom edges (0 = sharp)
...
// Rectangular slab, Z = -pedestal_height .. 0, with 45 deg chamfers
